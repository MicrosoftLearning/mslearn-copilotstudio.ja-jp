...
1. 先ほど作成した **[プロパティの取得]** エージェント フロー ツールを選択します。
   ...
   > [!NOTE]
   > このエージェント フローがツールの一覧に表示されない場合は、**[+ ツールの追加]** を選択し、**[フロー]** タブを選択して、**[プロパティの取得]** エージェント フローを選択します。 **[追加と構成]** を選択します。
...
1. **[ツール]** タブを選択し、両方のエージェント フローが一覧にあることを確認します。 ない場合は、**[+ ツールの追加]** > **[フロー]** を選択し、不足しているエージェント フローを選択します。 **[追加と構成]** を選択します。
