...
1. **[エージェント フローが正常に公開されました]** ポップアップで、**[エージェントに戻る]** を選択します。

1. 先ほど作成したエージェント フロー ツールを選択します。

1. **[詳細]** セクションで、フローの**名前**を `Get Property` に更新します。

1. **[説明]** を `Get properties with the right number of bedrooms` に更新します。
