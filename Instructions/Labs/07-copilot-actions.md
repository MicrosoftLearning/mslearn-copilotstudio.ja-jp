...
### タスク 1.2 - [プロパティの取得] ツールをトピックに追加する

1. **[Topics]** タブを選択します。

1. **[Book Showing]** トピックを選択します。

1. **[質問が必要なベッドルームの数]** ノードの下にある **+** アイコンを選択し、**[ツールの追加]** を選択し、**[ツール]** タブを選択してから、**[プロパティの取得]** エージェント フローを選択します。
...
1. 下部にある **[メッセージ]** ノードの下で **+** アイコンを選択し、**[ツールの追加]** を選択してから、**[予約リクエストの作成]** フローを選択します。
...
1. 閉じている場合は、ページの右上にある **[テスト]** アイコンを選択してテスト パネルを開きます。
