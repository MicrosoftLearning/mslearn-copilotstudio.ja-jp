...
この演習では、次のラボに使用する Dataverse ソリューションをインポートします。 このソリューションには、不動産物件を作成および管理するためのモデル駆動型アプリが含まれています。
...
### タスク 1.3 – 推奨されるソリューションを設定する

1. **[ソリューションに戻る]** (戻る矢印アイコン) を選択します。

1. **[優先するソリューションの設定]** を選択します。

1. **[Bookings (contoso)]** を選択します。
...
1. **省略記号 […]**  **Real Estate Property Management** モデル駆動型アプリ のメニューで、**[再生]** を選択します。 これは、新しい不動産物件レコードを作成できる単純なモデル駆動型アプリです。
